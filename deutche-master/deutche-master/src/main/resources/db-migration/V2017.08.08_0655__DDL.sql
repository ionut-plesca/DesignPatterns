...
insert into products values(6, 'Alice in Wonderland' , 2,  'REGULAR_FREQUENCY', 'SCARCE_RELEASES', 'BOOK_RENTAL_DRM');
insert into products values(7, 'Little Red Riding Hood ' , 2,  'REGULAR_FREQUENCY', 'ADULT_CONTENT', 'BOOK_RENTAL_DRM');
...
insert into rentals values(2, PARSEDATETIME ('31-07-13 11:34:24','dd-MM-yy hh:mm:ss'), 2, 1, 2, 1);
insert into rentals values(3, PARSEDATETIME ('21-05-13 11:34:24','dd-MM-yy hh:mm:ss'), 3, 1, 2, 1);
insert into rentals values(4, PARSEDATETIME ('30-04-13 11:34:24','dd-MM-yy hh:mm:ss'), 4, 1, 2, 1);

insert into client_rental values(1,1,1);
insert into client_rental values(2,1,2);
insert into client_rental values(3,1,3);
